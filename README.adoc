...
| link:dynamic-router-eip-multimodule/readme.md[Dynamic Router Eip Multimodule] (dynamic-router-eip-multimodule) | EIP | An example on how to use the Dynamic Router EIP component in Spring Boot with multiple modules
