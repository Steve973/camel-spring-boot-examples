...
| link:dynamic-router-eip-multimodule/readme.md[Dynamic Router Eip Multimodule] (dynamic-router-eip-multimodule) | EIP | Dynamic Router EIP component example in Spring Boot with multiple modules
