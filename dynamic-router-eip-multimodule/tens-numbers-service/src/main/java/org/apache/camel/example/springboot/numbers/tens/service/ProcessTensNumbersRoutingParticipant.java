...
import org.apache.camel.example.springboot.numbers.tens.model.CommandMessage;
import org.apache.camel.example.springboot.numbers.tens.model.ProcessNumberCommand;
...
@Service
public class ProcessTensNumbersRoutingParticipant {

    private static final Logger LOG = LoggerFactory.getLogger(ProcessTensNumbersRoutingParticipant.class);

    private static final String PROCESS_TENS_NUMBERS_ID = "processTensNumbers";
    ...
    public ProcessTensNumbersRoutingParticipant(
        ...
        this.predicate = e -> {
            ...
            return m.command().equals(PROCESS_NUMBER_COMMAND) && ((ProcessNumberCommand) m).number() % 10 == 0;
        };
    ...
    public void consumeMessage(final ProcessNumberCommand message) {
        ...
        LOG.info("Processed tens number: {}, total processed: {}", number, count);
    }
