...
import org.apache.camel.example.springboot.numbers.sevens.model.CommandMessage;
import org.apache.camel.example.springboot.numbers.sevens.model.ProcessNumberCommand;
...
@Service
public class ProcessSevensNumbersRoutingParticipant {

    private static final Logger LOG = LoggerFactory.getLogger(ProcessSevensNumbersRoutingParticipant.class);

    private static final String PROCESS_SEVENS_NUMBERS_ID = "processSevensNumbers";
    ...
    public ProcessSevensNumbersRoutingParticipant(
        ...
        this.predicate = e -> {
            ...
            return m.command().equals(PROCESS_NUMBER_COMMAND) && ((ProcessNumberCommand) m).number() % 7 == 0;
        };
    ...
    public void consumeMessage(final ProcessNumberCommand message) {
        ...
        LOG.info("Processed sevens number: {}, total processed: {}", number, count);
    }
