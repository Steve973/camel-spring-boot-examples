...
import org.apache.camel.example.springboot.numbers.fives.model.CommandMessage;
import org.apache.camel.example.springboot.numbers.fives.model.ProcessNumberCommand;
...
@Service
public class ProcessFivesNumbersRoutingParticipant {

    private static final Logger LOG = LoggerFactory.getLogger(ProcessFivesNumbersRoutingParticipant.class);

    private static final String PROCESS_FIVES_NUMBERS_ID = "processFivesNumbers";
    ...
    public ProcessFivesNumbersRoutingParticipant(
        ...
        this.predicate = e -> {
            ...
            return m.command().equals(PROCESS_NUMBER_COMMAND) && ((ProcessNumberCommand) m).number() % 5 == 0;
        };
    ...
    public void consumeMessage(final ProcessNumberCommand message) {
        ...
        LOG.info("Processed fives number: {}, total processed: {}", number, count);
    }
