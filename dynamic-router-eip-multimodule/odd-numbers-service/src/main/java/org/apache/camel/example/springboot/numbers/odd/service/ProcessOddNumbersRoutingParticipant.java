...
import org.apache.camel.example.springboot.numbers.odd.model.CommandMessage;
import org.apache.camel.example.springboot.numbers.odd.model.ProcessNumberCommand;
...
@Service
public class ProcessOddNumbersRoutingParticipant {

    private static final Logger LOG = LoggerFactory.getLogger(ProcessOddNumbersRoutingParticipant.class);

    private static final String PROCESS_ODD_NUMBERS_ID = "processOddNumbers";
    ...
    public ProcessOddNumbersRoutingParticipant(
        ...
        this.predicate = e -> {
            ...
            return m.command().equals(PROCESS_NUMBER_COMMAND) && ((ProcessNumberCommand) m).number() % 2 == 1;
        };
    ...
    public void consumeMessage(final ProcessNumberCommand message) {
        ...
        LOG.info("Processed odd number: {}, total processed: {}", number, count);
    }
