...
import org.apache.camel.example.springboot.numbers.fours.model.CommandMessage;
import org.apache.camel.example.springboot.numbers.fours.model.ProcessNumberCommand;
...
@Service
public class ProcessFoursNumbersRoutingParticipant {

    private static final Logger LOG = LoggerFactory.getLogger(ProcessFoursNumbersRoutingParticipant.class);

    private static final String PROCESS_FOURS_NUMBERS_ID = "processFoursNumbers";
    ...
    public ProcessFoursNumbersRoutingParticipant(
        ...
        this.predicate = e -> {
            ...
            return m.command().equals(PROCESS_NUMBER_COMMAND) && ((ProcessNumberCommand) m).number() % 2 == 0;
        };
    ...
    public void consumeMessage(final ProcessNumberCommand message) {
        ...
        LOG.info("Processed fours number: {}, total processed: {}", number, count);
    }
