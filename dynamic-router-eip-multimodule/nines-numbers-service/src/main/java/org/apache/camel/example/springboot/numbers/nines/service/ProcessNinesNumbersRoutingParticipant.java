...
import org.apache.camel.example.springboot.numbers.nines.model.CommandMessage;
import org.apache.camel.example.springboot.numbers.nines.model.ProcessNumberCommand;
...
@Service
public class ProcessNinesNumbersRoutingParticipant {

    private static final Logger LOG = LoggerFactory.getLogger(ProcessNinesNumbersRoutingParticipant.class);

    private static final String PROCESS_NINES_NUMBERS_ID = "processNinesNumbers";
    ...
    public ProcessNinesNumbersRoutingParticipant(
        ...
        this.predicate = e -> {
            ...
            return m.command().equals(PROCESS_NUMBER_COMMAND) && ((ProcessNumberCommand) m).number() % 9 == 0;
        };
    ...
    public void consumeMessage(final ProcessNumberCommand message) {
        ...
        LOG.info("Processed nines number: {}, total processed: {}", number, count);
    }
