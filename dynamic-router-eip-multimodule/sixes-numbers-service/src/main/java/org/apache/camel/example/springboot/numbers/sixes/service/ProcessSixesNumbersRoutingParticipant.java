...
import org.apache.camel.example.springboot.numbers.sixes.model.CommandMessage;
import org.apache.camel.example.springboot.numbers.sixes.model.ProcessNumberCommand;
...
@Service
public class ProcessSixesNumbersRoutingParticipant {

    private static final Logger LOG = LoggerFactory.getLogger(ProcessSixesNumbersRoutingParticipant.class);

    private static final String PROCESS_SIXES_NUMBERS_ID = "processSixesNumbers";
    ...
    public ProcessSixesNumbersRoutingParticipant(
        ...
        this.predicate = e -> {
            ...
            return m.command().equals(PROCESS_NUMBER_COMMAND) && ((ProcessNumberCommand) m).number() % 6 == 0;
        };
    ...
    public void consumeMessage(final ProcessNumberCommand message) {
        ...
        LOG.info("Processed sixes number: {}, total processed: {}", number, count);
    }
