package org.apache.camel.example.springboot.numbers.eights.service;
...
import org.apache.camel.example.springboot.numbers.eights.model.CommandMessage;
import org.apache.camel.example.springboot.numbers.eights.model.ProcessNumberCommand;
...
@Service
public class ProcessEightsNumbersRoutingParticipant {

    private static final Logger LOG = LoggerFactory.getLogger(ProcessEightsNumbersRoutingParticipant.class);

    private static final String PROCESS_EIGHTS_NUMBERS_ID = "processEightsNumbers";
    ...
    public ProcessEightsNumbersRoutingParticipant(
        ...
        this.predicate = e -> {
            ...
            return m.command().equals(PROCESS_NUMBER_COMMAND) && ((ProcessNumberCommand) m).number() % 8 == 0;
        };
    ...
    public void consumeMessage(final ProcessNumberCommand message) {
        ...
        LOG.info("Processed eights number: {}, total processed: {}", number, count);
    }
