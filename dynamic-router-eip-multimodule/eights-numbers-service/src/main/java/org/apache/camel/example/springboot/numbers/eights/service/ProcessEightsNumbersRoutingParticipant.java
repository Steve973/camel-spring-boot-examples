...
@Service
public class ProcessEightsNumbersRoutingParticipant extends ProcessNumbersRoutingParticipant {
    ...
    public ProcessEightsNumbersRoutingParticipant(
        ...
        super("eights", "processEightsNumbers", subscribeUri, routingChannel, subscriptionPriority,
                e -> {
                    CommandMessage m = e.getIn(CommandMessage.class);
                    return m.getCommand().equals(PROCESS_NUMBER_COMMAND) && ((ProcessNumberCommand) m).getNumber() % 8 == 0;
